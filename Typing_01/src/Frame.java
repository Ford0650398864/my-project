...
public class Frame extends JFrame implements ActionListener, KeyListener {
    ...
    private JButton viewScoresButton; // Add this line
    ...
    public Frame() {
        ...
        viewScoresButton.setFont(new Font("System", Font.BOLD, 20));
        ...
        button.setFont(new Font("System", Font.BOLD, 30));
    ...
    public void keyTyped(KeyEvent e) //keyTyped uses the key Character which can identify capital and lowercase difference in keyPressed it takes unicode so it also considers shift which creates a problem
    {
        if (passage.length() > 1) {
            ...
            else if (count == 200) //Once all 200 characters are typed we will end the time and calculate time elapsed
            {
                ...
                userScoreTable.displayUserScores();
            }
            ...
            if (typed < 200) {
                ...
                } //if we typde it wrong it will show red and still keep going and u can pressed the delete button to goback to the curren green position
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (ended) {
            userScoreTable.addUserScore(username, WPM);
            userScoreTable.displayAllUserScores();
            repaint();
        }
    }
